...
# No default token in 1.24 or newer
kubectl get secret -n kube-system $(kubectl get secrets -n kube-system | grep token | head -n1 | awk '{print $1}') --as=system:serviceaccount:secure-ops:monitoring
